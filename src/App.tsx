          ...
          >
            <form ref={formRef} onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div>
                ...
                />
                {errors.subject && (
                  <p id="subject-error" className="mt-1 text-sm text-red-400 flex items-center gap-1" role="alert">
                    <AlertCircle className="w-4 h-4" />
              ...
              <div>
                ...
                />
                {errors.message && (
                  <p id="message-error" className="mt-1 text-sm text-red-400 flex items-center gap-1" role="alert">
                    <AlertCircle className="w-4 h-4" />
