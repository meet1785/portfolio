            ...
            {isMobileMenuOpen && (
              ...
              >
                ...
                <div className="flex items-center gap-4 px-4 py-3 mt-2 mb-1 border-t border-white/10">
                   <a href={DATA.personalInfo.github} target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400 focus-visible:ring-offset-2 focus-visible:ring-offset-[#030712] rounded-full p-1" aria-label="GitHub Profile">
                     <Github className="w-5 h-5" />
                   </a>
                   <a href={DATA.personalInfo.linkedin} target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400 focus-visible:ring-offset-2 focus-visible:ring-offset-[#030712] rounded-full p-1" aria-label="LinkedIn Profile">
                     <Linkedin className="w-5 h-5" />
                   </a>
