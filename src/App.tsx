      ...
      <nav className={`fixed z-[100] w-full top-0 flex justify-center transition-all duration-700 ease-out ${scrolled ? 'pt-4' : 'pt-6'}`}>
        ...
        >
          ...
          <div className="hidden md:flex items-center gap-3 z-10 ml-4">
             <a href={DATA.personalInfo.github} target="_blank" rel="noopener noreferrer" aria-label="GitHub Profile" className="text-slate-400 hover:text-white transition-colors focus-visible:ring-2 focus-visible:ring-sky-500 focus-visible:outline-none rounded-full">
               <Github className="w-5 h-5" />
             </a>
             <a href={DATA.personalInfo.linkedin} target="_blank" rel="noopener noreferrer" aria-label="LinkedIn Profile" className="text-slate-400 hover:text-white transition-colors focus-visible:ring-2 focus-visible:ring-sky-500 focus-visible:outline-none rounded-full">
               <Linkedin className="w-5 h-5" />
             </a>
             <Link to="/contact" className="ml-2 bg-white text-black hover:bg-cyan-400 hover:text-black hover:shadow-[0_0_20px_rgba(34,211,238,0.4)] px-5 py-2 rounded-full text-sm font-bold transition-all duration-300 transform hover:scale-105 focus-visible:ring-2 focus-visible:ring-sky-500 focus-visible:outline-none">
               Let's Talk
             </Link>
          </div>

          <button
            className="md:hidden relative z-10 text-slate-300 hover:text-white transition-colors w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center focus-visible:ring-2 focus-visible:ring-sky-500 focus-visible:outline-none"
            ...
            {isMobileMenuOpen && (
              ...
              >
                ...
                <div className="flex items-center gap-4 px-4 py-3 mt-2 mb-1 border-t border-white/10">
                   <a href={DATA.personalInfo.github} target="_blank" rel="noopener noreferrer" aria-label="GitHub Profile" className="text-slate-400 hover:text-white focus-visible:ring-2 focus-visible:ring-sky-500 focus-visible:outline-none rounded-full">
                     <Github className="w-5 h-5" />
                   </a>
                   <a href={DATA.personalInfo.linkedin} target="_blank" rel="noopener noreferrer" aria-label="LinkedIn Profile" className="text-slate-400 hover:text-white focus-visible:ring-2 focus-visible:ring-sky-500 focus-visible:outline-none rounded-full">
                     <Linkedin className="w-5 h-5" />
                   </a>
                   <div className="flex-1" />
                   <Link to="/contact" onClick={closeMobileMenu} className="bg-white text-black px-4 py-1.5 rounded-full text-sm font-bold text-center focus-visible:ring-2 focus-visible:ring-sky-500 focus-visible:outline-none">
                     Hire Me
                   </Link>
                </div>
              </motion.div>
      ...
      <footer className="border-t border-white/6 py-8">
        <div className="max-w-6xl mx-auto px-6 flex flex-col sm:flex-row justify-between items-center gap-3 text-sm text-white/40">
          ...
          <div className="flex items-center gap-5">
            <a href="https://github.com/meet1785" target="_blank" rel="noopener noreferrer" className="hover:text-white/70 transition-colors focus-visible:ring-2 focus-visible:ring-sky-500 focus-visible:outline-none rounded-sm px-1">GitHub</a>
            <a href="https://linkedin.com/in/meetshah1708" target="_blank" rel="noopener noreferrer" className="hover:text-white/70 transition-colors focus-visible:ring-2 focus-visible:ring-sky-500 focus-visible:outline-none rounded-sm px-1">LinkedIn</a>
            <a href="mailto:meetshah1785@gmail.com" className="hover:text-white/70 transition-colors focus-visible:ring-2 focus-visible:ring-sky-500 focus-visible:outline-none rounded-sm px-1">Email</a>
          </div>
        </div>
      </footer>
    </motion.div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <a href="https://github.com/meet1785" className="text-white/60 hover:text-blue-400 transition-colors focus-visible:ring-2 focus-visible:ring-sky-500 focus-visible:outline-none rounded-sm px-1">
                    github.com/meet1785
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <a href="https://linkedin.com/in/meetshah1708" className="text-white/60 hover:text-indigo-400 transition-colors focus-visible:ring-2 focus-visible:ring-sky-500 focus-visible:outline-none rounded-sm px-1">
