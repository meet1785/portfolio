      ...
      <nav className={`fixed z-[100] w-full top-0 flex justify-center transition-all duration-700 ease-out ${scrolled ? 'pt-4' : 'pt-6'}`}>
        ...
        >
          ...
          <div className="hidden md:flex items-center gap-3 z-10 ml-4">
             <a href={DATA.personalInfo.github} aria-label="GitHub Profile" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-500 rounded-md">
               <Github className="w-5 h-5" />
             </a>
             <a href={DATA.personalInfo.linkedin} aria-label="LinkedIn Profile" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-500 rounded-md">
          ...
          <button
            className="md:hidden relative z-10 text-slate-300 hover:text-white transition-colors w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-500"
            ...
            {isMobileMenuOpen && (
              ...
              >
                ...
                <div className="flex items-center gap-4 px-4 py-3 mt-2 mb-1 border-t border-white/10">
                   <a href={DATA.personalInfo.github} aria-label="GitHub Profile" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-500 rounded-md">
                     <Github className="w-5 h-5" />
                   </a>
                   <a href={DATA.personalInfo.linkedin} aria-label="LinkedIn Profile" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-500 rounded-md">
                     <Linkedin className="w-5 h-5" />
                   </a>
