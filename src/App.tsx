        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-950 via-blue-950 to-slate-900 relative overflow-hidden">
          ...
          <div className="absolute inset-0 overflow-hidden">
            <motion.div 
              ...
              initial="initial"
              animate="animate"
              className="absolute -top-4 -left-4 w-96 h-96 bg-blue-600 rounded-full mix-blend-multiply filter blur-xl opacity-20"
            ></motion.div>
            <motion.div 
              variants={isMobile ? simpleFloat : float3D}
              initial="initial"
              animate="animate"
              className="absolute -top-4 -right-4 w-96 h-96 bg-cyan-500 rounded-full mix-blend-multiply filter blur-xl opacity-20"
            ></motion.div>
            <motion.div 
              variants={isMobile ? simpleFloat : rotate3D}
              initial="initial"
              animate="animate"
              className="absolute -bottom-8 left-20 w-96 h-96 bg-indigo-500 rounded-full mix-blend-multiply filter blur-xl opacity-20"
            ></motion.div>
            <motion.div 
              variants={isMobile ? simpleFloat : morphingBlob}
              initial="initial"
              animate="animate"
              className="absolute top-1/2 right-1/4 w-72 h-72 bg-sky-500 rounded-full mix-blend-multiply filter blur-xl opacity-15"
            ></motion.div>
            <motion.div 
              variants={isMobile ? simpleFloat : float3D}
              initial="initial"
              animate="animate"
              className="absolute bottom-1/4 left-1/3 w-64 h-64 bg-blue-400 rounded-full mix-blend-multiply filter blur-xl opacity-15"
            ></motion.div>
          </div>
            ...
            {Array.from({ length: 25 }).map((_, i) => (
              <motion.div
                ...
                style={{
                  ...
                  filter: 'blur(0.5px)',
                  boxShadow: `0 0 ${4 + Math.random() * 8}px rgba(56, 189, 248, 0.3)`,
                }}
              />
            ))}
          </div>
          ...
          >
            <div className="relative w-96 h-96 lg:w-[30rem] lg:h-[30rem]" style={{ perspective: '1000px' }}>
              ...
              <motion.div 
                ...
                initial="initial"
                animate="animate"
                className="absolute inset-0 bg-gradient-to-r from-blue-500 via-cyan-500 to-sky-400 blur-2xl opacity-20"
              ></motion.div>
              ...
              <motion.div 
                ...
                initial="initial"
                animate="animate"
                className="absolute -bottom-6 -left-6 w-12 h-12 bg-gradient-to-r from-indigo-500/40 to-blue-500/40 rounded-lg backdrop-blur-sm border border-white/30 shadow-lg"
                style={{ transformStyle: 'preserve-3d' }}
              ></motion.div>
              <motion.div 
                variants={isMobile ? simpleFloat : float3D}
                ...
                className="absolute top-1/2 -left-10 w-8 h-8 bg-gradient-to-r from-sky-500/40 to-cyan-500/40 rounded-full backdrop-blur-sm border border-white/30 shadow-lg"
                style={{ transformStyle: 'preserve-3d' }}
              ></motion.div>
              ...
              <motion.div 
                ...
                animate="animate"
                transition={{ delay: 1 }}
                className="absolute top-10 -right-4 w-6 h-6 bg-gradient-to-r from-teal-500/40 to-cyan-500/40 rotate-45 backdrop-blur-sm border border-white/30 shadow-lg"
                style={{ transformStyle: 'preserve-3d' }}
              ></motion.div>
            </div>
          </motion.div>
          ...
          <div className="text-center lg:text-left space-y-8">
            ...
            >
              <motion.div variants={scaleIn} transition={{ delay: 0.8 }}>
                <Link 
                  to="/works" 
                  className="group relative inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-blue-600 to-cyan-500 text-white font-semibold rounded-2xl transition-all duration-300 hover:scale-105 hover:shadow-2xl font-body overflow-hidden"
                >
  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          <h1 className="text-4xl lg:text-6xl font-bold text-white mb-6 font-heading">
            My <span className="bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">Resume</span>
          </h1>
          <p className="text-xl text-white/70 max-w-3xl mx-auto mb-8 font-body">
          ...
          <div className="flex justify-center">
            <motion.a 
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="inline-flex items-center space-x-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-cyan-500 text-white font-semibold rounded-xl hover:shadow-lg transition-all duration-300"
            >
          ...
          >
            ...
            <div className="space-y-8">
              ...
              <div className="border-l-4 border-cyan-500 pl-6">
                ...
                <p className="text-cyan-400 font-semibold mb-2">VaultOfCodes (Remote)</p>
                <ul className="text-white/70 space-y-2 font-body">
...
const ProjectCard = React.memo(({ title, description, link, github, tech, featured, category }: ProjectCardProps) => {
  ...
  return (
    ...
    >
      ...
      <motion.div 
        className="absolute inset-0 bg-gradient-to-br from-blue-500/10 via-cyan-500/10 to-sky-500/10 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"
        animate={isHovered ? { 
          scale: 1.05,
          rotateZ: 2,
        } : { 
      ...
      <motion.div 
        ...
        style={{
          background: 'linear-gradient(45deg, transparent, rgba(56, 189, 248, 0.1), transparent, rgba(59, 130, 246, 0.1), transparent)',
      ...
      {featured && (
        <motion.div 
          ...
          className="absolute -top-1 -right-1 bg-gradient-to-r from-blue-600 to-cyan-500 text-white text-xs font-semibold px-3 py-1.5 rounded-full shadow-xl z-20 border border-white/20"
          style={{ transformStyle: 'preserve-3d' }}
          whileHover={{ 
            scale: 1.15,
            rotateY: 10,
