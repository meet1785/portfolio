      ...
      <nav className={`fixed z-[100] w-full top-0 flex justify-center transition-all duration-700 ease-out ${scrolled ? 'pt-4' : 'pt-6'}`}>
        ...
        >
          ...
          <div className="hidden md:flex items-center gap-3 z-10 ml-4">
             <a aria-label="GitHub profile" href={DATA.personalInfo.github} target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-white transition-colors focus-visible:ring-2 focus-visible:ring-sky-500 rounded-full focus:outline-none">
               <Github className="w-5 h-5" />
             </a>
             <a aria-label="LinkedIn profile" href={DATA.personalInfo.linkedin} target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-white transition-colors focus-visible:ring-2 focus-visible:ring-sky-500 rounded-full focus:outline-none">
            ...
            {isMobileMenuOpen && (
              ...
              >
                ...
                <div className="flex items-center gap-4 px-4 py-3 mt-2 mb-1 border-t border-white/10">
                   <a aria-label="GitHub profile" href={DATA.personalInfo.github} target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-white focus-visible:ring-2 focus-visible:ring-sky-500 rounded-full focus:outline-none">
                     <Github className="w-5 h-5" />
                   </a>
                   <a aria-label="LinkedIn profile" href={DATA.personalInfo.linkedin} target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-white focus-visible:ring-2 focus-visible:ring-sky-500 rounded-full focus:outline-none">
                     <Linkedin className="w-5 h-5" />
                   </a>
